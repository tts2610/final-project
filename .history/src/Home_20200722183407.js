...
export default function Home() {
  ...
  useEffect(() => {
    ...
    async function getRes() {
      ...
      axios.get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${localStorage.getItem("currentLat")},${localStorage.getItem("currentLng")}&key=${process.env.REACT_APP_GOOGLEMAP}`).then((res) => setLocation(res.data.data.results[0]));
    }

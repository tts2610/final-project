...
export default function Home() {
  ...
  return (
    <div className="page">
      <div>
        <MyMap />
        <Image width="100" height="100" style={{ hover: "cursor", position: "absolute", zIndex: "10", top: "90%", left: "50%" }} src="https://media.giphy.com/media/Wtg8Bmgul1Qxc0otod/giphy.gif" alt="" />
      </div>

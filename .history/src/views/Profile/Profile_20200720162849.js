        ...
        <div class="col-lg-8" style={{ display: "contents" }}>
          <div class="panel profile-cover">
            <div class="profile-cover__img">
              <img style={{ cursor: "pointer" }} onClick={handleUpload} src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRWfQFfW1uCnPIAIq8LFynVLj1S4hwpPXaELQ&usqp=CAU" alt="">
                <Form.Group>
                  <Form.File label="Experience images*" onChange="" />
                </Form.Group>{" "}
              </img>
